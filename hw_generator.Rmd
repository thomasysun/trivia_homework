...
set.seed(dateseed)
z <- sample(newmovies$movieID, 40, replace = FALSE, prob = newmovies$wt/sum(newmovies$wt))

movieshw <- movies[z,]

# Don't run this unless you want to add a new dataset to the history:
# fwrite(movieshw, paste0("C:/Users/Thomas/Documents/Trivia/history/movieshomework", dateseed, ".csv"))
```
...
set.seed(dateseed)
y <- sample(newmusic$musicID, 40, replace = FALSE, prob = newmusic$wt/sum(newmusic$wt))

musichw <- music[y,]

# Don't run this unless you want to add a new dataset to the history:
# fwrite(musichw, paste0("C:/Users/Thomas/Documents/Trivia/history/musichomework", dateseed, ".csv"))
```
